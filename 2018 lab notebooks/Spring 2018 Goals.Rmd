...
|||||
|4/16||~~Make requested changes &~~ contact Melissa; ~~Intro wk4; Bug Ashu; l/sapply parsing functions to multiple XML files~~|yoga x2; meal plan; vaccum & sort Dax's clothes/toys; take clothes/toys to OUaC|
|||||
|4/23|Rackham Graduation (F)|Make requested changes & contact Melissa; Intro wk5; generate/fix MS figures; link data from XML pairs|yoga x2; meal plan; sort papers|
|||||
|4/30|Lab meeting presentation(R); Hayley & Zack in town (F)|Analyze/gather/plot ASM data; Inferential wk1; rearrange figures & rewrite text as needed|yoga x2; meal plan|
|||||
...
|||||
|5/14|Anniversary (T)|finalize Rmarkdown; Inferential wk3; parse/compile 50 XML files|yoga x2; meal plan; chest of drawers?|
|||||
