...
1. ASM Transfer articles
    ...
    + will probably need to do an analysis overtime to see trend in published vs unpublished
...
Talking about the monthly reports. Pulled from eJP, generally canned search queries. Screenshot, pasted & save as PDF vs. pulling from/reformatting excel sheet. Pat really likes the mBio report, which is more detailed. EJP has APIs, Melissa will write down the parameters for the current reports, then put me in communication with an eJP rep in order to work out the details of their APIs.
